import { Award, Briefcase, GraduationCap, Sparkles, Mail } from 'lucide-react';
...
export default function About() {
  const highlights = [
    {
      icon: <GraduationCap size={18} style={{ color: 'hsl(var(--color-purple))' }} />,
    ...
    {
      icon: <Briefcase size={18} style={{ color: 'hsl(var(--color-purple))' }} />,
  ...
  return (
    <section id="about" className="section" style={{ backgroundColor: 'hsl(var(--bg-secondary) / 0.4)' }}>
      <div className="container">
        ...
        >
          ...
          >
            ...
            <h3 style={{ fontSize: '1.4rem', fontWeight: 700, marginBottom: '4px' }}>Niatii</h3>
            <p style={{ fontSize: '0.85rem', color: 'hsl(var(--text-muted))', marginBottom: '24px', fontWeight: 500 }}>
            ...
            >
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <span style={{ color: 'hsl(var(--text-muted))' }}>Predikat IPK</span>
                <span style={{ fontWeight: 600 }}>3.92 (Cum Laude)</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                <span style={{ color: 'hsl(var(--text-muted))' }}>Pengalaman</span>
          ...
          <div style={{ textAlign: 'left' }}>
            <h3 style={{ fontSize: '1.6rem', marginBottom: '16px', fontWeight: 600, lineHeight: 1.3 }}>
              Menggabungkan Desain Fungsional dengan Kekuatan Kode & AI
            </h3>
            <p style={{ color: 'hsl(var(--text-secondary))', marginBottom: '20px', fontSize: '0.95rem', lineHeight: 1.6 }}>
              Sebagai lulusan baru di bidang teknologi informasi, saya berfokus menciptakan solusi digital yang bersih, terstruktur, 
              dan menyelesaikan masalah nyata. Saya tidak hanya berfokus pada fungsionalitas di balik layar, tetapi juga merancang 
              antarmuka web berpusat pada pengguna (user-centered) yang dipadukan dengan modul kecerdasan buatan (AI) secara praktis.
            </p>
            ...
            >
              <p style={{ fontStyle: 'italic', fontWeight: 500, color: 'hsl(var(--text-primary))', fontSize: '0.85rem' }}>
